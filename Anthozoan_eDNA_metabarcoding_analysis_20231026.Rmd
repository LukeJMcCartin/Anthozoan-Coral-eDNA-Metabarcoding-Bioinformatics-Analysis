...
For the sake of this demonstration, I am going to analyze eDNA metabarcoding libraries generated using the Anth-28S-eDNA primers. For  other primers, simply replace the primer sequences at the primer-trimming step and replace the reference database files for taxonomic classification.
