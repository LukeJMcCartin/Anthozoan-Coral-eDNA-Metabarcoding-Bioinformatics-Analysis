...
system.time(tax <- assignTaxonomy(seqs, "Anth_28S_assignTaxonomy_20250825.fasta", multi=TRUE, minBoot = 80,
                                  taxLevels = c("Kingdom", "Phylum", "Class", "Order", "Superfamily", "Family","Subfamily/Clade", "Genus"))) #classifying to the genus level with assignTaxonomy
unname(head(tax))
